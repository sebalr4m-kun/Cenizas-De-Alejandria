...
class UsuarioEstadisticas:
    ...
    COLORES_ACCIONES = {
        ...
        3: "#FF9100",  # Borrado Lógico -> Naranja Neón
        4: "#FF1744",  # Borrado Físico -> Rojo Vivo
        5: "#D500F9"   # Sesión -> Púrpura Eléctrico
    }
    ...
    def obtener_acciones_disponibles(self):
        """Retorna exclusivamente las acciones del módulo Usuarios."""
    ...
    def obtener_reporte_estadistico(self, agrupacion="Por Semana", offset_periodo=0, id_accion_filtro=None):
        ...
        titulo = f"Estadísticas - Usuarios ({nombre_accion}) [{agrupacion}]"
        ...
        try:
            sql = """
                ...
                WHERE fecha_hora >= %s AND fecha_hora <= %s
                  AND (modulo = 'Usuarios' OR id_accion = 5)
            """
